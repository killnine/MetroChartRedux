...
namespace MetroChartRedux
{
    ...
    public class RadialGaugePiece : PieceBase
    {
        ...
        public static readonly DependencyProperty RadiusProperty = DependencyProperty.Register("Radius", typeof(double), typeof(RadialGaugePiece), new PropertyMetadata(0.0));
        ...
        public static readonly DependencyProperty GeometryProperty = DependencyProperty.Register("Geometry", typeof(Geometry), typeof(RadialGaugePiece), new PropertyMetadata(null));

        public static readonly DependencyProperty BackgroundGeometryProperty = DependencyProperty.Register("BackgroundGeometry", typeof(Geometry), typeof(RadialGaugePiece), new PropertyMetadata(null));

        public static readonly DependencyProperty SelectionGeometryProperty = DependencyProperty.Register("SelectionGeometry", typeof(Geometry), typeof(RadialGaugePiece), new PropertyMetadata(null));

        public static readonly DependencyProperty MouseOverGeometryProperty = DependencyProperty.Register("MouseOverGeometry", typeof(Geometry), typeof(RadialGaugePiece), new PropertyMetadata(null));
        ...
        protected Geometry LayoutSegment(double startAngle, double endAngle, double radius, double gapScale, Point center, bool isDoughnut)
        {
            try
            {
                if (startAngle > 360)
        ...
        protected PathGeometry CloneDeep(PathGeometry pathGeometry)
        {
